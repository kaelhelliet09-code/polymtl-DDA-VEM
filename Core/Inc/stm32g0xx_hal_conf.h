...
/**
  ...
  * @brief   Project HAL modules, clock constants, and runtime options.
  * @note    Frequency constants are in hertz, VDD_VALUE is in millivolts, and
  *          interrupt priorities follow the Cortex convention where a lower
  *          number has higher urgency.
  ******************************************************************************
  * @attention
  *
